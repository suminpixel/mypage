        ...
        <div style={{backgroundColor:'#463AF5', paddingTop:84, paddingBottom:84, textAlign:'center'}}>
          ...
          <div style={{backgroundColor:'#323232', paddingTop:80, paddingBottom:120, textAlign:'center'}}>
              <div style={{width:1080, display:'inline-block', textAlign:'left', paddingLeft:20}}>
                  ...
                  <div style={{marginTop:38, display: 'flex', flexBasis:'50%'}}>
                        <div style={{width:206, cursor:'pointer', flex:1 }} id="snuper" onClick={(e) => onClickThisProject(1)}>
                            <img style={{width:206, marginBottom:19, paddingRight:24}} src={imgSnuperCover}/>
          ...
          <div style={{backgroundColor:'white',paddingTop:80, paddingBottom:100, textAlign:'center'}}>
              <div style={{width:1080, display:'inline-block',position:'relative', textAlign:'left', paddingLeft:20}}>
                  ...
                  <img src={imgDeco1} style={{width:500, position:'absolute', bottom:0, right:0}}/>
          ...
          {isPopupOpen ?
              <div>
                  <a onClick={onClickBackground} style={{backgroundColor:'#1B324298', position:'fixed', textAlign:'center', height:'100%', zIndex:3, top:0, left:0, right:0,}}>
                                ...
                                <div style={{marginLeft:48, marginTop:48, marginRight:48, marginBottom:48}}>
                                  ...
                                  <div style={{width:'100%',display: 'flex', flexBasis:'50%', marginTop:66}}>
                                      <div style={{width:'50%',cursor:'pointer', flex:1, padding:12 }} >
                                          <img style={{width:'100%', marginBottom:19, paddingRight:24}} src={imgSnuper0}/>
                                      </div>
                                      <div style={{width:'50%',cursor:'pointer', flex:1 , padding:12 }} >
                                          <img style={{width:'100%', marginBottom:19, paddingRight:24}} src={imgSnuper8}/>
                                      </div>
                                  </div>
                                    <div style={{width:'100%',display: 'flex', flexBasis:'50%'}}>
                                        <div style={{width:'100%',cursor:'pointer', flex:1 , padding:12 }} >
                                            <img style={{width:'100%', marginBottom:19, paddingRight:24}} src={imgSnuper3}/>
                                        </div>
                                    </div>
                                    <div style={{width:'100%',display: 'flex', flexBasis:'50%'}}>
                                        <div style={{width:'50%',cursor:'pointer', flex:1, padding:12 }} >
                                            <img style={{width:'100%', marginBottom:19, paddingRight:24}} src={imgSnuper2}/>
                                        </div>
                                        <div style={{width:'50%',cursor:'pointer', flex:1 , padding:12 }} >
                                            <img style={{width:'100%', marginBottom:19, paddingRight:24}} src={imgSnuper6}/>
                                        </div>
                                    </div>
                                    <div style={{width:'100%',display: 'flex', flexBasis:'50%'}}>
                                        <div style={{width:'50%',cursor:'pointer', flex:1, padding:12 }} >
                                            <img style={{width:'100%', marginBottom:19, paddingRight:24}} src={imgSnuper4}/>
                                        </div>
                                        <div style={{width:'50%',cursor:'pointer', flex:1 , padding:12 }} >
                                            <img style={{width:'100%', marginBottom:19, paddingRight:24}} src={imgSnuper5}/>
                                        </div>
                                    </div>
                              </div>
                              </div>
